    ...
    <>
      <div className="flex justify-center mt-4">
        <svg
          ...
          viewBox="0 0 384 512"
          className="w-8 h-8 fill-softred md:w-10 md:h-10"
        >
        ...
        <h1 className="text-grassgreen text-2xl md:text-4xl text-center font-bold mx-4">
          Projects
        </h1>
        <svg
          xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="mb-4 grid grid-cols-1 min-[1300px]:grid-cols-2">
        {projectList}
      </div>
    </>
  );
